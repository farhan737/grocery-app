    ...
    for (String line in lines) {
      ...
      try {
        ...
        Map<String, double?> weights = {
          '1K': parsePrice(columns[2]),
          '0.5K': parsePrice(columns[3]),
          '250G': parsePrice(columns[4]),
          '100G': parsePrice(columns[5]),
          '50G': parsePrice(columns[6]),
          '25G': parsePrice(columns[7]),
          '10G': parsePrice(columns[8]),
          '5K': parsePrice(columns[9]),
        };
        
        // Parse price per unit
        double? pricePerUnit = parsePrice(columns[10]);
